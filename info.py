...
PICS = (environ.get('PICS', 'https://graph.org/file/c678ba9f4150f97269436.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/41a08d01363c18ca909f1.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/8115d71feba6889c125fc.mp4")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6103092779 6497757690 5115691197').split()]
...
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', '586acb6e9f92e552cc071c9ff2eda4939bfa8203')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002121513235'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'https://t.me/+kdCUBx0zDT02ZDBl')).split()]
