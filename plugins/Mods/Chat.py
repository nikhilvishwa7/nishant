    ...
    try:
        ...
        k = await client.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('ᴀᴅᴅ ᴍᴇ ᴛᴏ ᴜʀ ɢʀᴏᴜᴘ', url="https://t.me/Lucy_Filter_bot?startgroup=true")
                            ],
                            [
                                InlineKeyboardButton(' ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ ', url="https://t.me/Movie7xChat/4"),
                                InlineKeyboardButton('ɴᴇᴡ sᴇʀɪᴇs', url="https://t.me/Netflixe_Original/14")
                            ]                            
                        ]
                    )
                )        
